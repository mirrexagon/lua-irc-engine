...
To allow greater flexibility, this module doesn't make use of a specific socket system. Instead, you set a function for `irc.send_raw` to use with `irc:set_send_func(func)`:
```lua
-- Using LuaSocket:
